...
- task: "working on the Electric proxy route, shape filters, or auth for /api/electric/$shape"
  load: "/workspaces/better-electric-start/node_modules/@electric-sql/client/skills/electric-proxy-auth/SKILL.md"
...
- task: "adding protected routes, redirects, or session-based route guards"
  load: "/workspaces/better-electric-start/node_modules/@tanstack/router-core/skills/router-core/auth-and-guards/SKILL.md"
